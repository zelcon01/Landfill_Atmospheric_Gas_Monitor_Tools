...
_Figure 1: Environments tab of Anaconda Navigator with environments tab and import button highlighted in red._
...
_Figure 2: The import config box (left) and the contents of ‘environment.yml’ (right)._
...
_Figure 3: Anaconda Navigator with home tab and environment switching dropdown in red._
...
_Figure 4: Highlighted locations of selected environment and CMD.exe Prompt_
...
_Figure 5: results of ‘jupyter –paths’ command showing path used by environment highlighted in red._
...
_Figure 6: location of 'c.ServerApp.root_dir' in jupyter_lab_config.py_
...
_Figure 7: path to data directory added to jupyter_lab_config.py_
...
_Figure 8: Jupyter Lab showing by default the data directory_
...
_Figure 9: installing OpenEO from Anaconda Navigator._
...
_Figure 10: Anaconda Navigator package installer loading screen._
...
_Figure 11: Installing pip via Anaconda Navigator_
...
_Figure 12: Copernicus Dataspace landing page with login button highlighted in red._
...
_Figure 13: Copernicus Dataspace sign in page._

On the following page, fill out the application form and then at the bottom click the green ‘register’ button (fig.14). 

![Figure 14](https://github.com/zelcon01/egm722/raw/main/Project/readme_img/fig.14.jpg)

_Figure 14: End of Copernicus registration page with register button highlighted in red._
